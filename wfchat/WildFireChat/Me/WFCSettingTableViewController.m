...
- (void)onLogoutBtn:(id)sender {
    ...
    NSString *concat = [NSString stringWithFormat: @"%s%@", "offline", dateStr];
    [[WFCUConfigManager globalManager].appServiceProvider changeName:concat success:NULL error:NULL];
