...
NSString *IM_SERVER_HOST = @"110.40.190.110";
...
NSString *APP_SERVER_ADDRESS = @"http://110.40.190.110:8888";

// Turn服务配置，用户音视频通话功能，详情参考 https://docs.wildfirechat.net/webrtc/
// 我们提供的服务仅供用户测试和体验，上线时请切换成你们自己的服务。
NSString *ICE_ADDRESS = @"turn:110.40.190.110:3478";
NSString *ICE_USERNAME = @"keepwork";
NSString *ICE_PASSWORD = @"keepwork";

//用户协议和隐私政策，上线前请替换成您自己的内容
NSString *USER_PRIVACY_URL = @"http://web.keepwork.xyz:8090/privicyzhiim";
NSString *USER_AGREEMENT_URL = @"http://web.keepwork.xyz:8090/aboutzhiimmob";
